...
1. **taster-py-rust.psp** (Python builder + Rust launcher)
...
1. **test-go-go.psp** (Go builder + Go launcher)
...
1. **test-go-rust.psp** (Go builder + Rust launcher)
...
1. **taster-ephemeral.psp** (Ephemeral keys)

   - Deterministic: false
   - ✅ Verification works

1. **taster-deterministic1.psp** (Deterministic build)
