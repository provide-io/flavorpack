...
from flavor.archive.operations import pack_operations, unpack_operations
...
class TestArchiveChain:
    ...
    def test_chain_reversal(self):
        ...
        assert reversed_chain.operations == [Operation.COMPRESS_GZIP, Operation.BUNDLE_TAR]
    ...
    def test_chain_optimization(self):
        ...
        original_chain._operations = [Operation.BUNDLE_TAR, Operation.BUNDLE_TAR, Operation.COMPRESS_GZIP]
...
class TestArchiveChainIntegration:
    ...
    def test_operations_compatible_with_pspf(self):
        ...
        from flavor.psp.format_2025.operations import OP_TAR, OP_GZIP
