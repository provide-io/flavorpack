...
def test_package(tmp_path):
    ...
    launcher_bin = Path("/Users/tim/code/gh/provide-io/flavorpack/ingredients/bin/flavor-go-launcher-darwin_arm64")
    ...
    result = subprocess.run([
        ...
        "--launcher-bin", str(launcher_bin),
        "--key-seed", "test123"
    ], cwd=taster_dir, capture_output=True, text=True)
