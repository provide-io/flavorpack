...
from modules import operations_pb2, slots_pb2, metadata_pb2, index_pb2, crypto_pb2
...
class TestProtobufFormat:
    ...
    def test_operation_packing(self):
        ...
        ops2 = [operations_pb2.OP_TAR, operations_pb2.OP_GZIP, operations_pb2.OP_AES256_GCM]
