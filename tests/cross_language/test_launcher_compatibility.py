...
class TestLauncherCompatibility:
    ...
    def test_launchers_can_run_package(self, test_package, launcher_binaries):
        ...
        for launcher_name, launcher_path in launcher_binaries.items():
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                try:
                    ...
                    pytest.fail(f"{launcher_name} launcher produced invalid output: {result.stdout}")
    
    def test_launcher_caching(self, test_package, launcher_binaries):
    ...
    def test_launcher_force_extract(self, test_package, launcher_binaries):
        ...
        for launcher_name, launcher_path in launcher_binaries.items():
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                assert "extracting" in result.stderr.lower() or "extract" in result.stderr.lower()
...
class TestCrossCompatibility:
    ...
    def test_packager_launcher_matrix(self, tmp_path, packager_binaries, launcher_binaries, packager, launcher):
...
""")
        ...
        if packager == "python":
            ...
            cmd = packager_binaries[packager] + [
                ...
                "--package-key", str(tmp_path / "keys" / "provider-private.key"),
                "--public-key", str(tmp_path / "keys" / "provider-public.key"),
