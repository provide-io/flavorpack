...
# Shared with Go and Rust
ENV_CACHE_DIR = "FLAVOR_CACHE_DIR"
...
# Python-only
ENV_BUILDER_BIN = "FLAVOR_BUILDER_BIN"
ENV_SETUP_LOG_LEVEL = "FLAVOR_SETUP_LOG_LEVEL"
ENV_INCLUDE_BUILD_HOST = "FLAVOR_INCLUDE_BUILD_HOST"
ENV_WHEEL_CACHE = "FLAVOR_WHEEL_CACHE"
ENV_METADATA_PACKAGE_NAME = "FLAVOR_METADATA_PACKAGE_NAME"
ENV_PACKAGE_NAME = "FLAVOR_PACKAGE_NAME"
ENV_PACKAGE = "FLAVOR_PACKAGE"
ENV_VERSION = "FLAVOR_VERSION"
ENV_ENTRY_POINT = "FLAVOR_ENTRY_POINT"
ENV_OUTPUT_FORMAT = "FLAVOR_OUTPUT_FORMAT"
ENV_OUTPUT_FILE = "FLAVOR_OUTPUT_FILE"
ENV_OS = "FLAVOR_OS"
ENV_ARCH = "FLAVOR_ARCH"
ENV_PLATFORM = "FLAVOR_PLATFORM"
ENV_OS_VERSION = "FLAVOR_OS_VERSION"
ENV_CPU_TYPE = "FLAVOR_CPU_TYPE"
# Runtime env vars (injected by Go/Rust launchers into child process)
ENV_CACHE_COMPAT = "FLAVOR_CACHE"  # workenv cache base (Go launcher sets this)
ENV_COMMAND_NAME = "FLAVOR_COMMAND_NAME"
ENV_ORIGINAL_COMMAND = "FLAVOR_ORIGINAL_COMMAND"
ENV_EXEC_MODE = "FLAVOR_EXEC_MODE"
ENV_LOG_PATH = "FLAVOR_LOG_PATH"
ENV_WORKENV_CACHE = "FLAVOR_WORKENV_CACHE"
ENV_KEY_SEED = "FLAVOR_KEY_SEED"
ENV_JSON_LOG = "FLAVOR_JSON_LOG"

# Launcher-specific log levels
ENV_LAUNCHER_LOG_LEVEL = "FLAVOR_LAUNCHER_LOG_LEVEL"
ENV_BUILDER_LOG_LEVEL = "FLAVOR_BUILDER_LOG_LEVEL"
