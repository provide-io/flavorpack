...
class ProgressBar:
    ...
    def __init__(self, total: int, description: str = "", width: int = 40, show_rate: bool = False):
...
class ProgressReporter:
    ...
    def create_bar(self, total: int, description: str = "", **kwargs) -> Optional[ProgressBar]:
    ...
    def create_spinner(self, description: str = "") -> Optional[Spinner]:
    ...
    @contextmanager
    def task(self, total: int, description: str = "", **kwargs):
