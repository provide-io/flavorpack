...
cat << 'EOF'
{
  "include": [
    ...
    {"name": "freebsd-amd64", "runner": "ubuntu-24.04", "platform": "freebsd_amd64", "continue_on_error": true},
    {"name": "freebsd-arm64", "runner": "ubuntu-24.04", "platform": "freebsd_arm64", "continue_on_error": true}
  ]
}
EOF