...
mod tests {
    ...
    fn test_paths_structure() {
        ...
        assert_eq!(paths.workenv(), PathBuf::from("/home/user/.cache/flavor/workenv/myapp"));
        assert_eq!(paths.metadata(), PathBuf::from("/home/user/.cache/flavor/workenv/.myapp.pspf"));
        assert_eq!(paths.instance(), PathBuf::from("/home/user/.cache/flavor/workenv/.myapp.pspf/instance"));
        assert_eq!(paths.lock_file(), PathBuf::from("/home/user/.cache/flavor/workenv/.myapp.pspf/instance/extract/lock"));
    }
}