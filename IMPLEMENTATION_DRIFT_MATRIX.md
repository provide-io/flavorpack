...
| metadata_offset | 24-31 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| metadata_size | 32-39 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| slot_table_offset | 40-47 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| slot_table_size | 48-55 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| slot_count | 56-59 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| flags | 60-63 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| public_key | 64-95 (32 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| metadata_checksum | 96-127 (32 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| integrity_signature | 128-639 (512 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| access_mode | 640 (1 byte) | ✅ | ✅ | ✅ | ✅ Aligned |
| cache_strategy | 641 (1 byte) | ✅ | ✅ | ✅ | ✅ Aligned |
| encoding_type | 642 (1 byte) | ✅ | ✅ | ✅ | ✅ Aligned |
| encryption_type | 643 (1 byte) | ✅ | ✅ | ✅ | ✅ Aligned |
| page_size | 644-647 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| max_memory | 648-655 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| min_memory | 656-663 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| cpu_features | 664-671 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| gpu_requirements | 672-679 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| numa_hints | 680-687 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| stream_chunk_size | 688-691 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| padding1 | 692-703 (12 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| build_timestamp | 704-711 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| build_machine | 712-743 (32 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| source_hash | 744-775 (32 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| dependency_hash | 776-807 (32 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| license_id | 808-823 (16 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| provenance_uri | 824-831 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| capabilities | 840-847 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| requirements | 848-855 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| extensions | 856-863 (8 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| compatibility | 864-867 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| protocol_version | 868-871 (4 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| future_crypto | 872-1383 (512 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| reserved | 1384-8191 (6816 bytes) | ✅ | ✅ | ✅ | ✅ Aligned |
| **Total** | **8192 bytes** | ✅ | ✅ | ✅ | ✅ Aligned |
