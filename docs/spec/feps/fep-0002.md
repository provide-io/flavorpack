...
--------------   ------------------------------   -------------
{workenv}        Workenv directory path          /home/user/.cache/flavor/workenv/app_1.0
...
{slot_N}         Path to extracted slot N         /home/user/.cache/flavor/workenv/app_1.0/slot_0
```
...
FLAVOR_CACHE_DIR         Cache base directory           /home/user/.cache/flavor
```
