...
1. File explorer/editor has file open
1. Antivirus scanning file
1. Temp files from previous runs not cleaned up
...
1. Set up CI/CD matrix for windows-arm64
1. Document and run manual Layer 2/3 tests
