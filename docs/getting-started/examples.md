...
=== "tasks.py" \`\`\`python #!/usr/bin/env python3 """Simple task manager CLI."""
...
=== "pyproject.toml" \`\`\`toml [project] name = "task-manager" version = "1.0.0" description = "Simple task management CLI"
...
=== "Usage" \`\`\`bash # Package the application flavor pack --manifest pyproject.toml --output tasks.psp
...
=== "api.py" \`\`\`python #!/usr/bin/env python3 """Simple REST API server."""
...
=== "pyproject.toml" \`\`\`toml [project] name = "task-api" version = "1.0.0" dependencies = [ "fastapi", "uvicorn", "pydantic" ]
...
=== "Usage" \`\`\`bash # Package the API flavor pack --manifest pyproject.toml --output api.psp
...
=== "process.py" \`\`\`python #!/usr/bin/env python3 """CSV data processor with pandas."""
...
=== "pyproject.toml" \`\`\`toml [project] name = "csv-processor" version = "1.0.0" dependencies = [ "pandas", "numpy" ]
...
=== "Usage" \`\`\`bash # Package the processor flavor pack --manifest pyproject.toml --output process.psp
...
=== "Python Code" \`\`\`python # menubar.py import rumps
...
{% raw %} - name: Build Package run: | flavor pack \
...
=== "test_package.py" \`\`\`python import subprocess import pytest
